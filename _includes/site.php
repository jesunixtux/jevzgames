...
function jg_head(array $page) {
    ...
    $description = isset($page['description']) ? $page['description'] : jg_text(
        'Official website for JEVZGames, the independent developer of JumpFall and its creator tools.',
        'Sitio oficial de JEVZGames, desarrollador independiente de JumpFall y sus herramientas para creadores.'
    );
        ...
        <div class="footer-grid">
            <div>
                ...
                <p><?php echo jg_e(jg_text(
                    'Independent game project developing JumpFall, player-made levels and safe creator tools.',
                    'Proyecto indie que desarrolla JumpFall, niveles creados por jugadores y herramientas seguras para creadores.'
                )); ?></p>
            </div>
...
function jg_jumpfall_schema() {
    return array(
        ...
        'inLanguage' => jg_lang(),
        'description' => jg_text(
            'JumpFall is an indie 2D platform game developed by JEVZGames, featuring a level editor, community maps, safe data-driven mods and Steam integration.',
            'JumpFall es un videojuego indie de plataformas 2D desarrollado por JEVZGames, con editor de niveles, mapas comunitarios, mods seguros basados en datos e integración con Steam.'
        ),
        'publisher' => array(
            '@type' => 'Organization',
            'name' => 'JEVZGames',
